...
ActiveRecord::Base.transaction do
  ...
  5.times do |index|
    FactoryBot.create(:pipedrive_person, id: pipedrive_person_id_index, first_name: "pipe#{index + 1}", email: Faker::Internet.email(name: "pipe#{index + 1}"))
    pipedrive_person_id_index += 1
  end

  5.times do |index|
    pipedrive_person = FactoryBot.create(:pipedrive_person, id: pipedrive_person_id_index + index, first_name: "pipesurf#{index + 1}", email: Faker::Internet.email(name: "pipesurf#{index + 1}"))
    pipedrive_person_id_index += 1
    debugger
